...
var Accordion = React.forwardRef(function(props, ref) {
  ...
  var createTabHeader = function createTabHeader2(tab, selected, index) {
    ...
    var className2 = classNames("p-accordion-header", {
    ...
    var header = tab.props.headerTemplate ? ObjectUtils.getJSXElement(tab.props.headerTemplate, tab.props) : React.createElement("span", {
  ...
  var createTabContent = function createTabContent2(tab, selected, index) {
    ...
    var className2 = classNames("p-toggleable-content", tab.props.contentClassName, tab.props.className);
