import {
  CSSTransition
} from "./chunk-2DDSUFYF.js";
import {
  Button,
  Ripple
} from "./chunk-SJBJXEGP.js";
import {
  InputText
} from "./chunk-GNA2WM23.js";
import {
  Portal
} from "./chunk-3ZVTEBAH.js";
import {
  PrimeReact,
  localeOption,
  localeOptions,
...
var CalendarPanel = React.forwardRef(function(props, ref) {
  ...
  return props.inline ? element : React.createElement(Portal, {
    element,
...
var Calendar = React.memo(React.forwardRef(function(props, ref) {
  var _classNames;
  ...
  var _React$useState3 = React.useState(false), _React$useState4 = _slicedToArray(_React$useState3, 2), overlayVisibleState = _React$useState4[0], setOverlayVisibleState = _React$useState4[1];
  var _React$useState5 = React.useState(null), _React$useState6 = _slicedToArray(_React$useState5, 2), viewDateState = _React$useState6[0], setViewDateState = _React$useState6[1];
  ...
  var _React$useState7 = React.useState("date"), _React$useState8 = _slicedToArray(_React$useState7, 2), currentView = _React$useState8[0], setCurrentView = _React$useState8[1];
  var _React$useState9 = React.useState(null), _React$useState10 = _slicedToArray(_React$useState9, 2), currentMonth = _React$useState10[0], setCurrentMonth = _React$useState10[1];
  var _React$useState11 = React.useState(null), _React$useState12 = _slicedToArray(_React$useState11, 2), currentYear = _React$useState12[0], setCurrentYear = _React$useState12[1];
  var _React$useState13 = React.useState([]), _React$useState14 = _slicedToArray(_React$useState13, 2), yearOptions = _React$useState14[0], setYearOptions = _React$useState14[1];
  ...
  var createBackwardNavigator = function createBackwardNavigator2(isVisible) {
    ...
    }, navigatorProps), React.createElement("span", {
  ...
  var createTitleMonthElement = function createTitleMonthElement2(month) {
    ...
    if (props.monthNavigator && props.view !== "month") {
      ...
      var _content = React.createElement("select", {
    ...
    return currentView === "date" && React.createElement("button", {
      className: "p-datepicker-month p-link",
      onClick: switchToMonthView,
      disabled: switchViewButtonDisabled()
    }, monthNames[month]);
  };
  var createTitleYearElement = function createTitleYearElement2() {
    if (props.yearNavigator) {
      var _yearOptions2 = [];
      ...
      var _content2 = React.createElement("select", {
    ...
    return currentView !== "year" && React.createElement("button", {
  ...
  var createTitleDecadeElement = function createTitleDecadeElement2() {
    ...
    if (currentView === "year") {
      ...
      }, props.decadeTemplate ? props.decadeTemplate(years) : React.createElement("span", null, "".concat(yearPickerValues()[0], " - ").concat(yearPickerValues()[yearPickerValues().length - 1])));
    }
    return null;
  };
  ...
  var createDayNames = function createDayNames2(weekDays) {
    ...
    if (props.showWeek) {
      var weekHeader = React.createElement("th", {
        scope: "col",
        key: "wn",
        className: "p-datepicker-weekheader p-disabled"
      }, React.createElement("span", null, localeOption("weekHeader", props.locale)));
  ...
  var createDateCellContent = function createDateCellContent2(date, className2, groupIndex) {
    ...
    }, content2, React.createElement(Ripple, null));
  };
  var createWeek = function createWeek2(weekDates, weekNumber, groupIndex) {
    ...
    if (props.showWeek) {
      var weekNumberCell = React.createElement("td", {
        key: "wn" + weekNumber,
  ...
  var createDateViewGrid = function createDateViewGrid2(monthMetaData, weekDays, groupIndex) {
    ...
    return currentView === "date" && React.createElement("div", {
      className: "p-datepicker-calendar-container"
    }, React.createElement("table", {
      className: "p-datepicker-calendar"
    }, React.createElement("thead", null, React.createElement("tr", null, dayNames)), React.createElement("tbody", null, dates)));
  };
  ...
  var createMonthYearView = function createMonthYearView2() {
    ...
    return React.createElement(React.Fragment, null, React.createElement("div", {
      ...
      className: "p-datepicker-header"
    }, backwardNavigator, React.createElement("div", {
      className: "p-datepicker-title"
  ...
  var createHourPicker = function createHourPicker2() {
    ...
    }), React.createElement(Ripple, null)), React.createElement("span", null, hourDisplay), React.createElement("button", {
      type: "button",
      className: "p-link",
      onMouseDown: function onMouseDown(e) {
        return onTimePickerElementMouseDown(e, 0, -1);
  ...
  var createMinutePicker = function createMinutePicker2() {
    ...
    return React.createElement("div", {
      ...
      className: "pi pi-chevron-up"
    }), React.createElement(Ripple, null)), React.createElement("span", null, minuteDisplay), React.createElement("button", {
      type: "button",
      className: "p-link",
      onMouseDown: function onMouseDown(e) {
        return onTimePickerElementMouseDown(e, 1, -1);
  ...
  var createSecondPicker = function createSecondPicker2() {
    if (props.showSeconds) {
      ...
      return React.createElement("div", {
        ...
        className: "pi pi-chevron-up"
      }), React.createElement(Ripple, null)), React.createElement("span", null, secondDisplay), React.createElement("button", {
        type: "button",
        className: "p-link",
        onMouseDown: function onMouseDown(e) {
          return onTimePickerElementMouseDown(e, 2, -1);
  ...
  var createMiliSecondPicker = function createMiliSecondPicker2() {
    if (props.showMillisec) {
      ...
      return React.createElement("div", {
        ...
        className: "pi pi-chevron-up"
      }), React.createElement(Ripple, null)), React.createElement("span", null, millisecondDisplay), React.createElement("button", {
        type: "button",
        className: "p-link",
        onMouseDown: function onMouseDown(e) {
          return onTimePickerElementMouseDown(e, 3, -1);
  ...
  var createAmPmPicker = function createAmPmPicker2() {
    if (props.hourFormat === "12") {
      ...
      return React.createElement("div", {
        ...
        className: "pi pi-chevron-up"
      }), React.createElement(Ripple, null)), React.createElement("span", null, display), React.createElement("button", {
        type: "button",
        className: "p-link",
        onClick: toggleAmPm
      }, React.createElement("span", {
  ...
  var createContent = function createContent2() {
    ...
    if (props.iconPos === "left") {
      return React.createElement(React.Fragment, null, button, input);
    }
    return React.createElement(React.Fragment, null, input, button);
  };
  ...
  return React.createElement("span", _extends({
    ...
    className,
    style: props.style
  }, otherProps), content, React.createElement(CalendarPanel, {
    ref: overlayRef,
